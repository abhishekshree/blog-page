      ...
      <div class="row">
        <div class="col-sm-2">
          ...
          <div class="col-sm-10">
            ...
            <div>
              <form action="editpost.php?Edit=<?php echo $queryparam; ?>" method="post" enctype="multipart/form-data">
                <fieldset>
              ...
              <textarea class="form-control" name="post" id="Postarea" rows="5"><?php echo $post; ?></textarea>
              </div>
